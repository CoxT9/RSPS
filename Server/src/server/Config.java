...
public class Config {
	...
	public static final String SERVER_NAME = "TAYLOR SCAPE";
	...
	*/
	...
	public static final int EXTRA_MULTIPLIER_CUZ_WHY_NOT = 100;

	public static final int WOODCUTTING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int MINING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int SMITHING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int FARMING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int FIREMAKING_EXPERIENCE = 50 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int HERBLORE_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int FISHING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int AGILITY_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int PRAYER_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int RUNECRAFTING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int CRAFTING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int THIEVING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int SLAYER_EXPERIENCE = 50 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int COOKING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
	public static final int FLETCHING_EXPERIENCE = 40 * EXTRA_MULTIPLIER_CUZ_WHY_NOT;
}
