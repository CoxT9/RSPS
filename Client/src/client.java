...
//		anIntArray1207[anInt1062] = id;
//		anIntArray1241[anInt1062] = type;
//		anIntArray1250[anInt1062] = delay + Sounds.anIntArray326[id];
	...
	private boolean parsePacket() {
		...
		try {
			...
			switch(pktType) {
				...
				case 174:
					int soundId = inStream.readUnsignedWord(); // todo: short and word may or not be interopable
					...
					anIntArray1241[anInt1062] = type;
					anIntArray1250[anInt1062] = delay + Sounds.anIntArray326[soundId];
					soundVolume[anInt1062] = volume;
					anInt1062++;
					pktType = -1;
					return true;
